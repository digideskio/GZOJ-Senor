...
// Path to user files relative to the document root.strstr($_SERVER['REQUEST_URI'],"fckeditor",1)

$TARGETPATH="upload/".date("Ym")."/";
$OJ_SAE=false;
$SAE_STORAGE_ROOT="http://hustoj-web.stor.sinaapp.com/";
$Config['UserFilesPath'] = '/'.$TARGETPATH ;
...
$Config['UserFilesAbsolutePath'] = "../../../../../".$TARGETPATH ;

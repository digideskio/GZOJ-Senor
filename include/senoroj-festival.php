<!-- Festival Processor By Senor_zhs -->
<?php
//节日处理器 by 张森
/* <script language="javascript" src="js_senor/festival/??.js"></script>  */

$fest=festival(date("Y-m-d"));
if($fest!='')
	echo '<script language="javascript" src="js_senor/festival/'.$fest.'.js"></script>';

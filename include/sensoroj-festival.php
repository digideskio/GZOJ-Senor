<!-- Festival Processor By Sensor_zhs -->
<?php
//节日处理器 by 张森
/* <script language="javascript" src="js_sensor/festival/??.js"></script>  */

$fest=festival(date("Y-m-d"));
if($fest!='')
	echo '<script language="javascript" src="js_sensor/festival/'.$fest.'.js"></script>';

function festival($today){
	$temp=$f_lunar=$f_solar='';
	$lunar_cls = new Lunar();
	$nl_today  = date("Y-m-d",$lunar_cls->S2L($today));  //获取农历
	$arr_lunar=array('01-01'=>'chunjie','01-15'=>'yuanxiao','05-05'=>'duanwu','07-07'=>'qixi','08-15'=>'zhongqiu','09-09'=>'chongyang');
	$arr_solar=array('01-01'=>'yuandan','02-14'=>'qingren','03-08'=>'funv','03-12'=>'zhishu','04-01'=>'yuren','04-08'=>'fuhuo','05-01'=>'laodong','05-04'=>'qingnian','05-12'=>'hushi','05-31'=>'wuyan','06-01'=>'ertong','07-01'=>'jiandang','08-01'=>'jianjun','09-10'=>'jiaoshi','10-01'=>'guoqing','10-31'=>'wansheng','12-24'=>'pingan','12-25'=>'shengdan');

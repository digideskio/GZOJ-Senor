...
?>
<div class="nav-li drp" style="right:60px;padding:0 15px 0 15px;text-align:center;"><a href="#user_menu" id="username_link" style=""><?=$user_id_show?> <span class="number" id="new_mail_cnt"><?=$new_mail_cnt?></span><span class="dropdown"></span></a><div class="dropdown-menu" style="width=100%;left:0px;padding:10px 5px 10px 6px;"><span class="dropdown-menu-i grey">当前没有新消息</span><div class="split"></div><span class="dropdown-menu-i"><a href="user-info-<?=$user_id_show?>">我的状态</a></span><span class="dropdown-menu-i"><a href="user-settings">个人设置</a></span><div class="split"></div><?php if(isset($_SESSION['administrator'])||isset($_SESSION['problem_editor'])){ ?><span class="dropdown-menu-i"><a href="admin" target="_blank">后台管理</a></span><div class="split"></div><?php }?><span class="dropdown-menu-i"><a href="javascript:" onclick="exitLogin();">登出</a></span></div></div>

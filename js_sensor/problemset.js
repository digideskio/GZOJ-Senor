...
{
		page=p;
		$("#loading-problemset").css({'background':'url(./img_sensor/loading.gif) no-repeat',"opacity":"1"});
...
function _getPage_JSON_handler(data)
{
	...
	{
		$("#loading-problemset").animate({'background':'url(./img_sensor/no.png) no-repeat'},300,"linear");
		$("#problemset_show").html(data["err"]).animate({opacity:"1"},300,"swing");
	}
}

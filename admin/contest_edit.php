...
<br>问题集:<input class=input-xxlarge type=text size=60 name=cproblem value='<?php echo $plist?>'>
<div style="display:none">
 可用语言（禁用）:<select name="lang[]"  multiple="multiple"    style="height:220px">
<?php
...
（如果是私有制，请填写：）参与用户，回车分隔的用户名:<textarea name="ulist" rows="20" cols="20"><?php if (isset($ulist)) { echo $ulist; } ?></textarea>
<p>提交按钮：<input type=submit value=Submit name=submit></p>

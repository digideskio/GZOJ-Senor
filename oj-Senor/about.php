...
<h1>关于本皮肤</h1><div class="em-l" style="margin-bottom:14px;"><b>Senor Style for GZOJ - 现代感</b></div><div class="em-l"><div class="em-t">作者：<a href="https://github.com/zhs490770/" target="_blank">zhs (Senor)</a></div></div><div class="em-l"><div class="em-t">版本：β</div></div><div class="em-l"><div class="em-t">特色：多处使用Ajax页面动态载入技术，登录、题库换页，提交评测等等都无需刷新，原处等待即可得到结果。</div></div><div class="em-l"><div class="em-t">Github:<a href="https://github.com/zhs490770/" target="_blank">oj-Senor</a></div></div>

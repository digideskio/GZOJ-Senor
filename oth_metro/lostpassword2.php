...
<body>
<div id="wrapper">
<?php require_once("../template/oj-header.php");?>
<div id=main>
...
<td><input name="vcode" size=4 type=text><img alt="click to change" src=../template/vcode.php onClick="this.src='vcode.php#'+Math.random()">*</td>
</tr>
<?php }?>
...
<div id=foot>
<?php require_once("../template/oj-footer.php");?>
